...
- **Windows Server unter Windows 11 mit Hyper-V installieren**
    ...
    Besonders achten auf die Konfiguration des virtuellen Switches. 
...
- **IP-Konfiguration für Rechner vergeben**
    ...
    Server mit statischen IP's versorgen entsprechend der [Netzwerk-Infrastruktur](#netzwerk-infrastruktur)
...
Detailierte Beschreibungen bitte im Netz nachschlagen :)

**Erster Domänen controller DC-01-SRV-V**
- Im server Manager AD Domänendienste, DNS
...
{{< expand "Fehlersuche (Hier Klicken!)" >}}
...
{{< expand "LockScreenOfficial" >}}
 ![newLockScreen.png](/images/adds-2026/image3.png "GPO Gandalf")
{{< /expand >}}
