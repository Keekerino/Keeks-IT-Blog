...
- **IP-Konfiguration für Rechner vergeben**
    ...
    Virtuelle switche in Hyper-V erstellen. Einmal intern (NATintern) und extern(NATextern)
...
Die Lösung war in diesem Fall den zweiten DC neu aufzusetzen und ihn *NICHT* manuell zur Domäne hinzuzufügen, sondern den Beitritt zur Domäne über die Hochstufung zum Domänencontroller zu realisieren. Vor allem die Vergabe der *“Credentials”* im nächsten Schritt nach der hier aufklappbaren Fehleranalyse ist sehr wichtig!
