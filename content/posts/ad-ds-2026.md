...
{{< image src="/images/adds-2026/grafik1.png" alt="Registry Eintrag 1" caption="Registry Eintrag in SOFTWARE\Policies\Microsoft\Windows\Personalization" width="800px" >}}

{{< image src="/images/adds-2026/grafik.png" alt="Registry Eintrag 2" caption="Registry Eintrag in SOFTWARE\Microsoft\Windows\CurrentVersion\PersonalizationCSP" width="800px" >}}

{{< image src="/images/adds-2026/image1.png" alt="Computerkonfiguration" caption="Nun wird über Computerkonfiguration → Einstellungen→ Windows-Einstellungen→ Dateien die Datei über die Bereitstellung lokal verfügbar gemacht" width="800px" >}}

 {{< image src="/images/adds-2026/image2.png" alt="Computerkonfiguration" caption="In den Eigenschaften der Datei noch Element Entfernen auswählen, dies ändert die Aktion beim Ausführen im ersten Reiter der Eisntellungen auf Ersetzen" width="800px" >}}  
